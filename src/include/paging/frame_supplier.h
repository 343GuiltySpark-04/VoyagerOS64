 ...
 * @ingroup paging
 *
 * Paging must allocate page-table frames both before and after the permanent PMM
 * is initialized. This tiny adapter keeps paging independent of the allocator
 * transition: early boot points it at early_alloc_page(), then memory bring-up
 * switches it to frame_alloc().
 */
#pragma once
...
/**
 * @brief Request one page-table frame from the currently authoritative supplier.
