...
static inline uint32_t hash(const uint8_t *data, size_t length)
{
    const uint8_t *data_u8 = data; // ignore warning lexer is being a cu*t
    uint32_t       hash    = 0;
...
#define HASHMAP_GET(HASHMAP, RET, KEY_DATA, KEY_LENGTH)                         \
    ({                                                                          \
        ...
        for (size_t HASHMAP_GET_i = 0;                                          \
             HASHMAP_GET_i < HASHMAP_GET_bucket->filled;                        \
             HASHMAP_GET_i++)                                                   \
        {                                                                       \
...
#define HASHMAP_SGET(HASHMAP, RET, STRING)                                   \
    ({                                                                       \
        ...
        HASHMAP_GET(                                                         \
            HASHMAP, RET, HASHMAP_SGET_string, strlen(HASHMAP_SGET_string)); \
    })
...
#define HASHMAP_SREMOVE(HASHMAP, STRING)                                      \
    ({                                                                        \
        ...
        HASHMAP_REMOVE(                                                       \
            HASHMAP, HASHMAP_SREMOVE_string, strlen(HASHMAP_SREMOVE_string)); \
    })
    ...
    {                                                                     \
        ...
        {                                                                 \
            HASHMAP_INSERT_hashmap->buckets =                             \
                malloc(HASHMAP_INSERT_hashmap->cap *                      \
        ...
        {                                                                 \
            ...
            HASHMAP_INSERT_bucket->items =                                \
                malloc(HASHMAP_INSERT_bucket->cap *                       \
        ...
        __auto_type HASHMAP_INSERT_item =                                 \
            &HASHMAP_INSERT_bucket->items[HASHMAP_INSERT_bucket->filled]; \
                                                                          \
        memcpy(HASHMAP_INSERT_item->key_data,                             \
               HASHMAP_INSERT_key_data,                                   \
...
#define HASHMAP_SINSERT(HASHMAP, STRING, ITEM)         \
    ...
    {                                                  \
        ...
        HASHMAP_INSERT(HASHMAP,                        \
                       HASHMAP_SINSERT_string,         \
                       strlen(HASHMAP_SINSERT_string), \
                       ITEM);                          \
    } while (0)
