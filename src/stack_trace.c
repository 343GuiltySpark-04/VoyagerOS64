...
/**
 * @brief Walk the stack and print it to stdout. This is a debugging function.
 * It will print the address list as follows : 1. Size of the stack trace is
 * equal to max_size. 2. Address list is walked from bottom to top and all
 * addresses below it are printed.
...
/**
 * @brief Print a stack trace. Unwind to the previous frame is printed as well
 * as the stack trace of the function being called.
 * @param max_frames The maximum number of frames to unwind. To use the maximum
 * value set in the k_mode struct set this to 0 or NULL.
 */
...
/**
 * @brief Dumps a block of data as hex. This is useful for debugging and to
 * ensure that the data is in hex format. credits to:
