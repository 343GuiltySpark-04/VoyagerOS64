...
__attribute__((no_sanitize("undefined"))) static uint32_t blend_gradient_from_box(struct gterm_t *gterm, size_t x, size_t y, uint32_t bg_px, uint32_t hex)
{
    ...
    if (distance > gterm->margin_gradient)
        return bg_px;
...
__attribute__((no_sanitize("undefined"), always_inline)) static inline void genloop(struct gterm_t *gterm, size_t xstart, size_t xend, size_t ystart, size_t yend, uint32_t (*blend)(struct gterm_t *gterm, size_t x, size_t y, uint32_t orig))
{
